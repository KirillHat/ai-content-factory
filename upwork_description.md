...
**Deliverables include:** live Make.com canvas screenshots (`screenshots/sample_*.png`), 1080×1350 card samples generated by the Pillow renderer, the Notion CMS schema seeds, and architecture / Notion / Slack mockups (`screenshots/01_*.png` … `08_*.png`) — happy to walk through any of it on a call.
